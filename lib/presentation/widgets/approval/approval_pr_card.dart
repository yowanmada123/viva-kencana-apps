...
class ApprovalPrCard extends StatefulWidget {
  final ApprovalPrFSunrise requests;
              ...
              if (state is ApprovalPrListLoadingState) {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    _buildSectionTitle(widget.requests.millName),
                    Padding(
                      ...
                      TimelineProgress(
                        steps: [
                          TimelineStep(
                            header: "Pengajuan",
                            detail:
                                widget.requests.wCreatedBy.isNotEmpty
                                    ? widget.requests.wCreatedBy
                                    : '-',
                          ...
                          TimelineStep(
                            header: "Approve 1",
                            detail:
                                widget.requests.wAprv1By.isNotEmpty
                                    ? widget.requests.wAprv1By
                                    : '-',
                          ...
                          TimelineStep(
                            header: "Approve 2",
                            detail:
                                widget.requests.wAprv2By.isNotEmpty
                                    ? widget.requests.wAprv2By
                                    : '-',
