...
class SalesActivityHistoryDetailImagesScreen extends StatefulWidget {
  ...
  const SalesActivityHistoryDetailImagesScreen({
    super.key,
    required this.historyDetail,
  });

  @override
  State<SalesActivityHistoryDetailImagesScreen> createState() =>
      _SalesActivityHistoryDetailImagesScreenState();
}

class _SalesActivityHistoryDetailImagesScreenState
    extends State<SalesActivityHistoryDetailImagesScreen> {
  @override
  void dispose() {
    super.dispose();
  }
  ...
  void initState() {
    log(
      'Access to lib/presentation/sales_activity/sales_activity_history_detail_images_screen.dart',
    );
    super.initState();
    context.read<SalesActivityHistoryVisitDetailListImageBloc>().add(
      FetchSalesActivityImages(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<
        SalesActivityHistoryVisitDetailListImageBloc,
        SalesActivityHistoryVisitDetailListImageState
      >(
